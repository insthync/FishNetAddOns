...
namespace FishNetSerializerSourceGenerator
{
    public static class GlobalOptions
    {
        ...
        /// </summary>
        public const string ProjectPath = "fishnet.insthync.serializing.projectpath";
        /// <summary>
        /// Override the output folder where the generator flush logs and generated files.
        /// </summary>
        public const string OutputPath = "fishnet.insthync.serializing.outputfolder";
        /// <summary>
        /// Override the namespace used for generated code.
        /// </summary>
        public const string Namespace = "fishnet.insthync.serializing.namespace";
        /// <summary>
        /// Override the class name used for generated code.
        /// </summary>
        public const string ClassName = "fishnet.insthync.serializing.classname";
        /// <summary>
        /// Enable/Disable writing generated code to output folder
        /// </summary>
        public const string WriteFilesToDisk = "fishnet.insthync.serializing.write_files_to_disk";
        /// <summary>
        /// Enable/Disable writing logs to the file (default is Temp/FishNetSerializerGenerated/SourceGenerator.log)
        /// </summary>
        public const string WriteLogsToDisk = "fishnet.insthync.serializing.write_logs_to_disk";
        /// <summary>
        /// The minimal log level. Available: Debug, Warning, Error. Default is error. (NOT SUPPORTED YET)
        /// </summary>
        public const string LoggingLevel = "fishnet.insthync.serializing.logging_level";

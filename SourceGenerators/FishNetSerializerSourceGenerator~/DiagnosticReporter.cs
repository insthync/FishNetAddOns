    ...
    internal static class DiagnosticHelper
    {
        static public DiagnosticDescriptor CreateErrorDescriptor(string message)
        {
            return new DiagnosticDescriptor(
                "FishNetSerializer",
                "FishNetSerializer Generator Error",
                message,
                "SourceGenerator",
        ...
        {
            return new DiagnosticDescriptor("FishNetSerializer", "FishNetSerializer Generator", message, "SourceGenerator", DiagnosticSeverity.Warning, true);
        }
        static public DiagnosticDescriptor CreateInfoDescriptor(string message)
        {
            return new DiagnosticDescriptor("FishNetSerializer", "FishNetSerializer Generator", message, "SourceGenerator", DiagnosticSeverity.Info, true);
        }
        static public DiagnosticDescriptor CreateException(Exception e)
        {
            ...
            return new DiagnosticDescriptor("FishNetSerializer", "Unhandled Exception", b.ToString(), "SourceGenerator", DiagnosticSeverity.Error, true);
        }

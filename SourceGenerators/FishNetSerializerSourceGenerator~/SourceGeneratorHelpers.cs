...
namespace FishNetSerializerSourceGenerator
{
    ...
    internal static class Helpers
    {
        ...
        static private ThreadLocal<string> s_Namespace;
        static private ThreadLocal<string> s_ClassName;
        ...
        {
            get => s_Namespace.Value;
            private set => s_Namespace.Value = value;
        }

        static public string ClassName
        {
            get => s_ClassName.Value;
            private set => s_ClassName.Value = value;
        }
        ...
        static Helpers()
        {
            s_OutputFolder = new ThreadLocal<string>(() => Path.Combine("Temp", "FishNetSerializerGenerated"));
            s_ProjectPath = new ThreadLocal<string>();
            s_Namespace = new ThreadLocal<string>(() => "FishNet.Insthync.Serializing");
            s_ClassName = new ThreadLocal<string>(() => "DataSerializer");
        ...
        static public void SetupContext(GeneratorExecutionContext executionContext)
        {
            ...
            Namespace = executionContext.GetOptionsString(GlobalOptions.Namespace, Namespace);
            ClassName = executionContext.GetOptionsString(GlobalOptions.ClassName, ClassName);
